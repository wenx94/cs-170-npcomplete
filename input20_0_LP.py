...
bigM = 40
wizzies = set()
Paris = LpVariable("Paris", 1, 20, "Integer")
wizzies.add("Paris")
Daragh = LpVariable("Daragh", 1, 20, "Integer")
wizzies.add("Daragh")
Skylar = LpVariable("Skylar", 1, 20, "Integer")
wizzies.add("Skylar")
Janette = LpVariable("Janette", 1, 20, "Integer")
wizzies.add("Janette")
Gene = LpVariable("Gene", 1, 20, "Integer")
wizzies.add("Gene")
Conner = LpVariable("Conner", 1, 20, "Integer")
wizzies.add("Conner")
Pam = LpVariable("Pam", 1, 20, "Integer")
wizzies.add("Pam")
Chase = LpVariable("Chase", 1, 20, "Integer")
wizzies.add("Chase")
Amari = LpVariable("Amari", 1, 20, "Integer")
wizzies.add("Amari")
Neal = LpVariable("Neal", 1, 20, "Integer")
wizzies.add("Neal")
Dominick = LpVariable("Dominick", 1, 20, "Integer")
wizzies.add("Dominick")
Lianne = LpVariable("Lianne", 1, 20, "Integer")
wizzies.add("Lianne")
Joni = LpVariable("Joni", 1, 20, "Integer")
wizzies.add("Joni")
Ruben = LpVariable("Ruben", 1, 20, "Integer")
wizzies.add("Ruben")
Mckenna = LpVariable("Mckenna", 1, 20, "Integer")
wizzies.add("Mckenna")
Curt = LpVariable("Curt", 1, 20, "Integer")
wizzies.add("Curt")
Oisin = LpVariable("Oisin", 1, 20, "Integer")
wizzies.add("Oisin")
Wesley = LpVariable("Wesley", 1, 20, "Integer")
wizzies.add("Wesley")
Carla = LpVariable("Carla", 1, 20, "Integer")
wizzies.add("Carla")
Ayesha = LpVariable("Ayesha", 1, 20, "Integer")
wizzies.add("Ayesha")
